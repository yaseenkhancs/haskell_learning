...
isPalindrome "" = True
isPalindrome str = if head(str) == last(str) then isPalindrome(init(tail str)) else False
...
palindromify str = if isPalindrome(str) then str else palindromify(init(tail(str)))
